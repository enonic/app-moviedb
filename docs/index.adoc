...
When looking at the result in Query Playground, you should see something like this (mouse over the link to reveal the image):
...
This is what the original higher resolution image content actually looks like - also notice how images are stored and handled just like any other piece of content:
